...
<section class="section">
    <div class="container">
        <div class="d-flex justify-content-center category-filter mb-5">
            <a href="<?php echo BASE_URL; ?>/menu.php" class="btn-filter <?php echo !$cat_filter ? 'active' : ''; ?>">All Items</a>
            <?php
            $categories->data_seek(0);
            while ($cat = $categories->fetch_assoc()):
            ?>
            <a href="<?php echo BASE_URL; ?>/menu.php?cat=<?php echo $cat['slug']; ?>" class="btn-filter <?php echo $cat_filter === $cat['slug'] ? 'active' : ''; ?>">
        ...
        <div class="row g-4">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="coffee-card">
                    ...
                    <div class="card-body">
                        <span style="font-size:0.75rem; color:var(--text-muted); font-weight:500; text-transform:uppercase;"><?php echo htmlspecialchars($item['cat_name']); ?></span>
